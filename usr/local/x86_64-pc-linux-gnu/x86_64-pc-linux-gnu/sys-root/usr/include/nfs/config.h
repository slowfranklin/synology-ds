...
#define HAVE_AUTHGSS_FREE_PRIVATE_DATA 1
...
/* DONT use <sys/queue.h> of GLIBC 2.3 */
#define SYNO_NO_SYS_QUEUE

/* DONT call validate_export() */
#define SYNO_NO_VALIDATE_EXPORT

/* [DSM] #36256 support nfs current connections */
#define SYNO_CURRENT_CONNECTIONS

#define SYNO_DEFAULT_MNT_OPT

/* [DSM] #44152  nfs advance option, use conf file and keytab on /etc/nfs/ */
#define SYNO_NFS_KERBEROS_FILE

/* [DSM] #44152  nfs advance option, set udp prefer rsize/wsize */
#define SYNO_NFSD_UDP_PACKET

/* [DSM] #55927 Provide a interface for user to enable command "chmod" or not on ACL share*/
#define SYNO_NFSD_UNIX_PRI

/* [DSM] #45985  fix warning "error in gss_free_lucid_sec_context(): GSS_S_NO_CONTEXT" */
#define SYNO_NFSD_RM_NO_CONTEXT_WARNING

/* [DSM] #45990 concat secinfo when export path have V4Root flag*/
#define SYNO_NFSD_V4ROOT_CONCAT_SECINFO

/* [DSM] #53115 nfsv4 idmap support ldap user and group */
#define SYNO_NFS4_IDMAP_SUP_LDAP

/* [DSM] #73594 fix export error if network prefix is 0 */
#define SYNO_EXPORT_NETMASK_ZERO
