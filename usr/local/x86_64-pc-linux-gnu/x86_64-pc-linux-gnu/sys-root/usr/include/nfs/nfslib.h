...
#endif
#ifndef SZF_NFS_CONNECTION_REC
#define SZF_NFS_CONNECTION_REC	"/var/tmp/nfs_cur_con.log"
#endif
#ifndef SZF_NFS_PREFER_PACKET_SIZE
#define SZF_NFS_PREFER_PACKET_SIZE "/proc/fs/nfsd/udppacketsize"
#endif

#ifdef MY_ABC_HERE
#define SZF_SYNO_NFS_CONF "/etc/nfs/syno_nfs_conf"
#define SZK_NFS_UDP_READ_SIZE "udp_read_size"
#define SZK_NFS_UDP_WRITE_SIZE "udp_write_size"
#define SYNO_NFSD_UDP_PACKET_MAX_SIZE 32768
#define SYNO_NFSD_UDP_PACKET_MIN_SIZE 4096
#define SYNO_NFSD_UDP_PACKET_DEF_SIZE 8192
#endif

#ifdef MY_ABC_HERE
#define SZK_NFS_UNIX_ENABLE "nfs_unix_pri_enable"
#define SZF_NFS_UNIX_PRI "/proc/fs/nfsd/unix_privilege_enable"
#endif
...
struct rmtabent *	getrmtabent(int log1, long *pos);
...
struct rmtabent *	fgetrmtabent(FILE *fp, int log1, long *pos);
