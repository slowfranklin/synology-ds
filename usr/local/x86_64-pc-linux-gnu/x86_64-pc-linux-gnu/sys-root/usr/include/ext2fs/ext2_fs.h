...
#define MY_ABC_HERE			/* This is defined in kernel syno_user.h */
#define MY_ABC_HERE				/* This should be defined for build process. */
#define MY_ABC_HERE		/* Auto remap report via debugfs */
#define MY_ABC_HERE				/* Query fs clean via e2fsck */
#define MY_ABC_HERE				/* FSCK bitmap mapping to files */
#define MY_ABC_HERE				/* Show fsck progress in /tmp */
#if defined(MY_ABC_HERE) || defined(MY_DEF_HERE) || defined(MY_DEF_HERE)
#define MY_ABC_HERE			/* Fix 16TB online resize limitation. It also add more reserved GDT for created volume. */
#endif
#define MY_ABC_HERE	/* Ignore fsck error with "mount future".*/
#define MY_ABC_HERE				/* This is for quota check. */
#define MY_ABC_HERE				/* This is for kernel unicode fix. */
#define MY_ABC_HERE			/* Show mkfs progress in /tmp */
#define MY_ABC_HERE	/* Rename default volume label */
#define MY_ABC_HERE		/* Fix reserved space for root on 100MB */
#define MY_ABC_HERE		/* Config mkfs on /etc.defaults/mke2fs.conf */
#define MY_ABC_HERE         /* Do not create lost+found directory when mkfs.ext4 */
#define MY_ABC_HERE			/* Show resize progress in /tmp */
#define MY_ABC_HERE			/* reduce online resize memory usage. */
#define MY_ABC_HERE	/* Query fs resize capability. */
#define MY_ABC_HERE		/* Skip add reserved blocks when resize */
#define MY_ABC_HERE		/* Query fs supported 64bit feature. */
#define MY_ABC_HERE		/* Query fs supported meta_bg feature. */
#define s_frags_per_group s_clusters_per_group	/* define s_frags_per_group back for earlier user tools, ex.extundelete. */
#define l_i_reserved2 l_i_checksum_lo			/* define l_i_reserved2 back for earlier user tools, ex.extundelete. */
#define MY_ABC_HERE			/* discable discard in mkfs to speed up */
#define MY_ABC_HERE			/* Show badblocks progress */
...
#define EXT4_S_ERR_END ext4_offsetof(struct ext2_super_block, s_mount_opts)
	...
	__u32	s_syno_hash_magic;	/* Enable Htree if the magic is given */
#else
