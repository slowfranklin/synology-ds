...
#ifdef MY_ABC_HERE
#define EXT2_FLAG_FILE_BITMAP	0x200000
#endif

#ifdef MY_ABC_HERE
#define SYNO_MAX_RESERVED_GDT_SIZE 8128	// 8192 - (1 << s_log_groups_per_flex)*4
#define SYNO_MAX_RESERVED_GDT_SIZE_OLD	8189 // 8192 - 3
#define SYNO_REDUCE_OLD_GDT_GROUP_COUNT 3904 // (SYNO_MAX_RESERVED_GDT_SIZE_OLD-SYNO_MAX_RESERVED_GDT_SIZE)*8192/128 (per gdb is 8192MB, per group 128MB)
#endif
...
#ifdef MY_ABC_HERE
#define EXT2FS_BMAP64_FILE_BITARRAY 99
#endif
...
#ifdef MY_ABC_HERE
extern errcode_t ext2fs_u32_list_add(ext2_u32_list bb, __u64 blk);
extern int ext2fs_u32_list_find(ext2_u32_list bb, __u64 blk);
extern int ext2fs_u32_list_test(ext2_u32_list bb, blk64_t blk);
#else
...
#ifdef MY_ABC_HERE
extern int ext2fs_u32_list_iterate(ext2_u32_iterate iter, blk64_t *blk);
#else
...
extern int ext2fs_badblocks_list_test(ext2_badblocks_list bb,
				    blk64_t blk);
extern int ext2fs_u32_list_del(ext2_u32_list bb, __u64 blk);
extern void ext2fs_badblocks_list_del(ext2_u32_list bb, __u64 blk);
#else
extern errcode_t ext2fs_badblocks_list_add(ext2_badblocks_list bb,
					   blk_t blk);
extern int ext2fs_badblocks_list_test(ext2_badblocks_list bb,
...
#ifdef MY_ABC_HERE
extern errcode_t badblocks_list_add(badblocks_list bb, blk64_t blk);
extern int badblocks_list_test(badblocks_list bb, blk64_t blk);
#else
...
#ifdef MY_ABC_HERE
extern int badblocks_list_iterate(badblocks_iterate iter, blk64_t *blk);
#else
...
/* ind_block.c */
#ifdef MY_ABC_HERE
errcode_t ext2fs_syno_read_multi_ind_block(ext2_filsys fs, blk_t blk, void *buf, int syno_multiple_gdt);
errcode_t ext2fs_syno_write_multi_ind_block(ext2_filsys fs, blk_t blk, void *buf, int syno_multiple_gdt);
#endif
...
extern errcode_t ext2fs_get_next_inode(ext2_inode_scan scan, ext2_ino_t *ino,
			       struct ext2_inode *inode);
#ifdef MY_ABC_HERE
extern errcode_t ext2fs_get_next_in_used_inode(ext2_inode_scan scan, ext2_ino_t *ino,
			       struct ext2_inode *inode);
#endif
