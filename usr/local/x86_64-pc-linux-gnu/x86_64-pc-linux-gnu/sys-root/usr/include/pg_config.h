...
#define PACKAGE_STRING "PostgreSQL 9.3.14"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "postgresql"

/* Define to the version of this package. */
#define PACKAGE_VERSION "9.3.14"
...
#define PG_VERSION "9.3.14"

/* PostgreSQL version as a number */
#define PG_VERSION_NUM 90314

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 9.3.14 on x86_64-pc-linux-gnu, compiled by x86_64-pc-linux-gnu-gcc (crosstool-NG 1.20.0) 4.9.3 20150311 (prerelease), 64-bit"
...
/* DS2.0 #9068, pgstat_init needs to check track_counts and track_activities.
 * If track_counts or track_activities enable, the disks would not enter hibernation. */
#define SYNO_HIBERNATION

/* DS3.2 Check compatibility of data and server binary. */
#define SYNO_CHECK_COMPATIBILITY

/* DS3.2 Dump max alignment. */
#define SYNO_DUMP_MAX_ALIGNMENT
