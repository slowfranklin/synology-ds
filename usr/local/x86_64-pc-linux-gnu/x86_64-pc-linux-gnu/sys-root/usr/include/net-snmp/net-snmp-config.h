...
#define NETSNMP_CONFIGURE_OPTIONS " '--host=x86_64-pc-linux-gnu' '--target=x86_64-pc-linux-gnu' '--build=i686-pc-linux-gnu' '--prefix=/usr' '--disable-manuals' '--disable-scripts' '--disable-set-support' '--disable-debugging' '--without-perl-modules' '--disable-embedded-perl' '--disable-perl-cc-checks' '--with-endianness=little' '--with-default-snmp-version=2' '--with-sys-contact=admin@diskstation' '--with-sys-location=Unknown' '--with-logfile=/var/log/snmpd.log' '--with-persistent-directory=/var/lib/net-snmp' '--with-cc=/usr/local/x86_64-pc-linux-gnu/bin/x86_64-pc-linux-gnu-ccache-gcc' '--with-linkcc=/usr/local/x86_64-pc-linux-gnu/bin/x86_64-pc-linux-gnu-ccache-gcc' '--without-nl' '--with-ar=/usr/local/x86_64-pc-linux-gnu/bin/x86_64-pc-linux-gnu-ar' '--enable-ipv6' '--with-transports=UDPIPv6 TCPIPv6' '--with-mib-modules=' 'build_alias=i686-pc-linux-gnu' 'host_alias=x86_64-pc-linux-gnu' 'target_alias=x86_64-pc-linux-gnu' 'CC=/usr/local/x86_64-pc-linux-gnu/bin/x86_64-pc-linux-gnu-ccache-gcc' 'CFLAGS=-DSYNOPLAT_F_X86_64 -O2 -include /usr/syno/include/platformconfig.h -DSYNO_ENVIRONMENT -DBUILD_ARCH=64 -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -DSYNO_RUNNING_DSM_BUILD_SYSTEM -g -pipe -fstack-protector --param=ssp-buffer-size=4 -Wformat -Wformat-security -D_FORTIFY_SOURCE=2 -O2 -Wno-unused-result' 'LDFLAGS= -Wl,-z,relro -Wl,--as-needed -Wl,--no-undefined' 'LIBS=' 'CPPFLAGS=-DSYNO '"
...
#define NETSNMP_SYS_CONTACT "admin@diskstation"
