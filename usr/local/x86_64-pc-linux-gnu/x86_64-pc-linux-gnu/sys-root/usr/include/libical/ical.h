...
typedef enum icalvalue_kind {
   ICAL_ANY_VALUE=5000,
    ...
    ICAL_UTCOFFSET_VALUE=5006,
    ICAL_RECUR_VALUE=5007,
    ICAL_STRING_VALUE=5008,
    ICAL_CLASS_VALUE=5009,
    ICAL_DURATION_VALUE=5010,
    ICAL_FLOAT_VALUE=5011,
    ICAL_BINARY_VALUE=5012,
    ICAL_PERIOD_VALUE=5013,
    ICAL_METHOD_VALUE=5014,
    ICAL_CARLEVEL_VALUE=5015,
    ICAL_TRANSP_VALUE=5016,
    ICAL_TRIGGER_VALUE=5017,
    ICAL_DATETIME_VALUE=5018,
