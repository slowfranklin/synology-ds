...
namespace TagLib {
  ...
  namespace ASF {
    ...
    public:
...
#ifdef MY_ABC_HERE
      /*!
       * Returns the album artist name; if no album name is present in the tag
       * String::null will be returned.
       */
      virtual String albumArtist() const;

      /*!
       * Returns the composer; if no composer is present in the tag
       * String::null will be returned.
       */
      ...
      /*!
       * Sets the disc number to \a i.  If \a s is 0 then this value will be cleared.
       */
