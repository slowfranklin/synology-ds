...
struct _PedDiskOps {
        ...
        int (*partition_set_system) (PedPartition* part,
                                     const PedFileSystemType* fs_type);
#ifdef MY_ABC_HERE
        int (*partition_set_system_ext) (PedPartition* part,
                                         const PedFileSystemType* fs_type,
                                         long MBR_Partition_ID);
#endif
...
#ifdef MY_ABC_HERE
        long (*partition_get_mbr_partition_id) (PedPartition* part);
#endif
};
...
extern int ped_partition_set_system (PedPartition* part,
                                     const PedFileSystemType* fs_type);
#ifdef MY_ABC_HERE
extern int ped_partition_set_system_ext (PedPartition* part, const PedFileSystemType* fs_type, long MBR_Partition_ID);
extern long ped_partition_get_mbr_partition_id(PedPartition* part);
#endif
...
#ifdef MY_ABC_HERE
extern int ped_disk_fast_delete_partation (PedDisk* disk, int iStart, int iEnd);
#endif
