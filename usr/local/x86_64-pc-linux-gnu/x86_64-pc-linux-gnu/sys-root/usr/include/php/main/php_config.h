...
/* uname -a output */
#define PHP_UNAME "Linux build11 4.4.39-1-lts #1 SMP Thu Dec 22 20:04:07 CST 2016 x86_64 GNU/Linux"
...
#define SYNO_OPEN_BASE_DIR
#define SYNO_FTP
#define SYNO_GLOB_NOMATCH
#define SYNO_IGNORE_ALREADY_LOADED
#define SYNO_DEFAULT_CTYPE

#define SYNO_DISABLE_PGSQL
#define SYNO_PHP_SRC_DIR        "/usr/syno/synoman/phpsrc/"
#define SYNO_WEBMAIL_DIR        "/@appstore/MailStation/roundcubemail/"

#define SYNO_SQLITE_TIME_OUT    300

#ifdef SYNO_PLAT_FS_SKIP_CHECK_OWNER
# define SYNO_SKIP_CHECK_OWNER
#endif
